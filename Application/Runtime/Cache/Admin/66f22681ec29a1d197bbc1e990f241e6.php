      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-info">
            <form action="/HSLshop/index.php/Admin/Goods/editGoods/GoodsId/<?php echo ($data["goods_id"]); ?>" enctype="multipart/form-data" method="post" >
            <table class="table table-bordered">
              <tbody>
                <tr>
                  <td>商品名称：</td>
                  <td><input type="text" name="goodsname" value="<?php echo ($data["goods_name"]); ?>"></td>
                </tr>
                <tr>
                  <td>商品分类：</td>
                  <td>
                ...
                <tr>
                  <td>型号：</td>
                  <td><input type="text" name="goodsmodel" value="<?php echo ($data["goods_model"]); ?>"></td>
                </tr>
                <tr>
                  <td>规格：</td>
                  <td><input type="text" name="goodsspec" value="<?php echo ($data["goods_spec"]); ?>"></td>
                </tr>
                <tr>
                  <td>产地：</td>
                  <td><input type="text" name="goodsplace" value="<?php echo ($data["goods_place"]); ?>"></td>
                </tr>
                <tr>
                  <td>价格：</td>
                  <td><input type="text" name="goodsprice" value="<?php echo ($data["goods_price"]); ?>"></td>
                </tr>
                <tr>
                  <td>库存数量：</td>
                  <td><input type="text" name="goodsnumber" value="<?php echo ($data["goods_number"]); ?>"></td>
                </tr>
                <tr>
                  <td>商品图片：</td>
