          ...
          <div class="table-info">
            ...
            <table class="table table-bordered">
              ...
              <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><a href="/HSLshop/index.php/Admin/Goods/editGoodsType/GoodsTypeId/<?php echo ($vo["cat_id"]); ?>">修改</a><a href="/HSLshop/index.php/Admin/Goods/delGoodsType/GoodsTypeId/<?php echo ($vo["cat_id"]); ?>">删除</a></td>
