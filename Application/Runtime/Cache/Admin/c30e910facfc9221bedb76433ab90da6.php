      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-info">
            ...
            <form action="/HSLshop/index.php/Admin/Index/editUser/UserId/<?php echo ($UserDetail["user_id"]); ?>" method="post">
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="text" name="username" value="<?php echo ($UserDetail["user_name"]); ?>"></td>
                    <td><input type="text" name="nickname" value="<?php echo ($UserDetail["nickname"]); ?>"></td>
                    <td><input type="text" name="email" value="<?php echo ($UserDetail["email"]); ?>"></td>
                    <td><input type="text" name="password" value="<?php echo ($UserDetail["password"]); ?>"></td>
                  </tr>
                </tbody>
